        ...
        <div className="inline-block w-3/4 bg-gray-400/30 p-10 rounded-xl">
            <div className="float-left">
                ...
                <div className="flex text-xl">
                    <p>Do not have account? Sign in</p> &nbsp; <a href="" className="underline">Here</a> &nbsp; or
                </div>
            ...
            <div className="float-right text-right w-2/4">
                ...
                <button onClick={handleLogin} className="bg-blue-600 px-4 py-2 rounded hover:bg-blue-700">Login</button>
            </div>
        </div>
    );
}
